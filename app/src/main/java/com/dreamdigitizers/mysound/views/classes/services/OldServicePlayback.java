...
public class OldServicePlayback extends OldServiceMediaPlayer {
    ...
    protected long getProtectedPlaybackActions() {
        return OldServicePlayback.SUPPORTED_PLAYBACK_ACTIONS;
    }
    ...
    protected Notification createNotification(Track pTrack) {
        ...
        this.mNotificationBuilder.setContentTitle(pTrack.getTitle());
        this.mNotificationBuilder.setContentText(pTrack.getAlbum());
        ...
        if(this.getState() == OldServiceMediaPlayer.STATE__PLAYING) {
    ...
    private PendingIntent createNotificationIntent() {
        return PendingIntent.getActivity(this, OldServiceMediaPlayer.REQUEST_CODE, new Intent(this, ActivityMain.class), PendingIntent.FLAG_UPDATE_CURRENT);
    }

    public class ServiceBinder extends Binder {
        public OldServicePlayback getService() {
            return OldServicePlayback.this;
        }
    }
}
