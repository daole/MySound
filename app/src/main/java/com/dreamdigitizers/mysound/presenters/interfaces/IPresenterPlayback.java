...
public interface IPresenterPlayback extends IPresenterRx {
    ...
    void userFavorites(UtilsDialog.IRetryAction pRetryAction, int pId);
    void userFavorites(UtilsDialog.IRetryAction pRetryAction, int pId, int pLinkedPartitioning, int pLimit, String pOffset);
